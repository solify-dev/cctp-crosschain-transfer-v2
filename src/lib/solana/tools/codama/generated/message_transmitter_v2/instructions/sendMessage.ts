...
export type SendMessageInstructionDataArgs = { params: SendMessageParamsArgs };

export function getSendMessageInstructionDataEncoder(): Encoder<SendMessageInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', fixEncoderSize(getBytesEncoder(), 8)],
      ['params', getSendMessageParamsEncoder()],
    ]),
...
export function getSendMessageInstructionDataDecoder(): Decoder<SendMessageInstructionData> {
  return getStructDecoder([
    ...
    ['params', getSendMessageParamsDecoder()],
  ]);
}
...
> = {
  ...
  params: SendMessageInstructionDataArgs['params'];
};
  ...
  if (!accounts.senderAuthorityPda.value) {
    accounts.senderAuthorityPda.value = await getProgramDerivedAddress({
      ...
      seeds: [
        ...
        getAddressEncoder().encode(expectAddress(accounts.senderProgram.value)),
      ],
    });
  }
